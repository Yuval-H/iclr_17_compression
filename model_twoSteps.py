...
class ImageCompressor_twoSteps(nn.Module):
    def __init__(self, out_channel_N=128):
        super(ImageCompressor_twoSteps, self).__init__()
        self.Encoder1 = Analysis_net_17(out_channel_N=out_channel_N)
        self.Decoder1 = Synthesis_net_17(out_channel_N=out_channel_N)
    ...
    def forward(self, input_image):
        ...
        recon_image = self.Decoder1(compressed_feature_renorm)
