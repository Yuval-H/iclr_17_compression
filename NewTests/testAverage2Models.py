...
model1 = Cheng2020Attention()
model2 = Cheng2020Attention()
#model = Cheng2020Attention_highBitRate2()

pretrained_model_path1 = '/home/access/dev/iclr_17_compression/checkpoints_new/new_net/HoloPix50k/0.031bpp/model_best_weights00111.pth'
pretrained_model_path2 = '/home/access/dev/iclr_17_compression/checkpoints_new/new_net/Sharons dataset/4 bit - verify/model_bestVal_loss_msssim.pth'
...
#file_msssim = open('/home/access/dev/DSIN/sharons code/ToSend/images/5.values_list/HoloPix50k/twoStepsCompression/msssim_list_HoloPix50k_target_0.031bpp_twoStepsNet.txt',"a")
...
for i in range(len(stereo1_path_list)):
    ...
    final_im1_recon = (final_im1_recon1 + final_im1_recon2) / 2
